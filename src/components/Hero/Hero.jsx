...
import ConditionWeTreat from '/src/components/conditionwetreat/ConditionWeTreat';
import AboutUsSelection from '/src/components/AboutUsSelection/AboutUsSelection';
import MentalHealthCare from '/src/components/MentalHealthCarry/MentalHealthCarry';
import ServicesSection from '/src/components/ServiceSection/ServicesSection';
import MentalHealthStats from '/src/components/MentalHealthStats/MentalHealthStats';
import GuidePrinciples from '/src/components/GuidePrinciples/GuidePrinciples';
import RealStories from '/src/components/RealStories/RealStories';
import WellnessHero from '/src/components/WellnessHero/WellnessHero';
    ...
    <div className="font-sans">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 md:bottom-20 md:right-20 z-20 w-60 bg-white rounded-lg shadow-lg overflow-hidden">
          <img
            src="/src/assets/fourtytofifty/41.jpg"
            alt="Service"
      ...
      <div className="w-full bg-green-400 py-4 flex justify-center">
        <button className="border border-black cursor-pointer px-4 shadow shadow-lg shadow-white py-2 rounded-full font-semibold hover:bg-green-500 transition">
          GO TO POST GALLERY
        </button>
      </div>
      ...
      <div className="bg-white px-4 sm:px-6 lg:px-20 py-10 space-y-6">
        ...
        <div className="flex flex-wrap justify-between gap-4">
          ...
          <div className="flex items-center">
            <button className="bg-black text-white cursor-pointer px-6 py-3 rounded-md hover:bg-gray-800 transition">
              Book An Appointment
            </button>
          </div>
        </div>
